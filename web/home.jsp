<%-- 
    Document   : home
    Created on : 28 Οκτ 2018, 6:49:55 μμ
    Author     : Bella
--%>
    ...
    <body class="text-center">
        ...
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main role="main" class="inner cover">
                <h1 class="cover-heading">Upload your MP3.</h1>
                <p class="lead">Now, upload your MP3 files. Show your MP3s lists and find all the information about your favorite
                    songs. </p>

                <form method="post" action="MP3Servlet" enctype="multipart/form-data">
                    <div class="cover-container">
                        <div class="form-row justify-content-center">
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    <input type="file" accept="audio/mp3" name="myfile" class="custom-file-input" id="file" onchange="checkfile(this);"
                                           required>
